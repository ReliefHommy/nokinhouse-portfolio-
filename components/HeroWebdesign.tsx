        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-5xl lg:text-6xl">
              Scalable{" "}
              <span className="text-indigo-400 dark:text-indigo-400">Digital Infrastructure</span>
              <br className="hidden sm:block" />
              for Asian Entrepreneurs{" "}
              <span className="text-indigo-400 dark:text-indigo-400">in Europe</span>
            </h1>

            {/* Subheadline */}
            <p className="mt-6 max-w-xl text-lg leading-8 text-gray-600 dark:text-gray-300">
              Asian businesses in the EU share common operational hurdles: navigating complex EU regulations (VAT, compliance), managing multi-language content, and bridging the gap between traditional service and modern digital expectations.
            </p>
