  ...
  const services = [
    {
      ...
      icon: <Church className="h-8 w-8 text-purple-500" />,
    },
    {
      ...
      icon: <CookingPot className="h-8 w-8 text-purple-500" />,
    },
    {
    ...
    },
    {
      ...
      icon: <StoreIcon className="h-8 w-8 text-purple-500" />,
    },
    {
  ...
  return (
    <section className="bg-white dark:bg-gray-950 py-24">
      <div className="mx-auto max-w-7xl px-6 text-center">
        <h2 className="text-3xl font-bold tracking-tight text-violet-400 dark:text-white sm:text-4xl">
          <span className="text-indigo-800">What&apos;s on</span> Somtam
        </h2>
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <Card key={service.title} className="shadow-lg hover:shadow-xl transition duration-300">
